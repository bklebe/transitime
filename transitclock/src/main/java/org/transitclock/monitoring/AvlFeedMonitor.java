...
public class AvlFeedMonitor extends MonitorBase {
   ...
   * @param agencyId
   */
  public AvlFeedMonitor(
      CloudwatchService cloudwatchService, EmailSender emailSender, String agencyId) {
  ...
  protected boolean acceptableEvenIfTriggered() {
    ...
    if (activeBlocks.size() == 0) {
      setAcceptableEvenIfTriggeredMessage(
          "No currently active blocks " + "so AVL feed considered to be OK.");
      return true;
    }
    return false;
  }
