...
public interface CacheQueryInterface extends Remote {
  ...
  public List<IpcArrivalDeparture> getTripArrivalDepartures(
      String tripId, LocalDate date, Integer starttime) throws RemoteException;

  /**
   * @return a list of the keys that have values in the historical average cache for schedules based
   *     services
   * @throws RemoteException
   */
  ...
  /**
   * @return a list of the keys that have values in the historical average cache for frequency based
   *     services.
   * @throws RemoteException
   */
