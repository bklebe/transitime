...
public interface VehiclesInterface extends Remote {
  ...
  /**
   * Gets from the server IpcActiveBlocks for blocks that are currently active without vehicle data.
   *
  ...
  /**
   * Gets from the server IpcActiveBlocks for blocks that are currently active with vehicle data for
   * a particular route.
   *
  ...
  public Collection<IpcActiveBlock> getActiveBlocksAndVehiclesByRouteId(
      String routeId, int allowableBeforeTimeSecs) throws RemoteException;

  /**
   * Gets from the server IpcActiveBlocks for blocks that are currently active with vehicle data for
   * all routes with given route name.
   *
  ...
  /**
   * Gets from server IpcVehicle info for all vehicles currently associated with a block. Each block
   * should have a IpcVehicle in the returned collection.
   *
   * @return Collection of Vehicle objects
   * @throws RemoteException
   */
