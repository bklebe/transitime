...
public class RestartableMessageProducer {
  ...
  public void sendObjectMessage(Serializable object) throws JMSException {
    ...
    try {
      ...
      // message again.
      logger.error(
          "Trying to open session/connection again because when calling "
    ...
    try {
      ...
      logger.error(
          "Trying to send create producer and then send "
  ...
  public void sendTextMessage(String message) throws JMSException {
    ...
    try {
      ...
      try {
        ...
        logger.error(
            "Got NamingException exeption when trying to " + "re-initiate the connection", e);
        // Throw the initial JMSException
        throw e;
      }
