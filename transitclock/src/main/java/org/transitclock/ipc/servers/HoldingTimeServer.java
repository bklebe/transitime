...
public class HoldingTimeServer extends AbstractServer implements HoldingTimeInterface {
  ...
  /**
   * Starts up the HoldingTimeServer so that RMI calls can be used to query holding times stored in
   * he cache. This will automatically cause the object to continue to run and serve requests.
   *
   * @param agencyId
