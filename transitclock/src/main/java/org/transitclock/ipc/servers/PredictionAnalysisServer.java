 ...
 */
public class PredictionAnalysisServer extends AbstractServer
    implements PredictionAnalysisInterface {
   ...
   *
   * @param agencyId
   * @return the singleton PredictionAnalysisServer object. Usually does not need to used since the
  ...
  public List<IpcPredictionForStopPath> getRecordedTravelTimePredictions(
    ...
    List<PredictionForStopPath> result =
        PredictionForStopPath.getPredictionForStopPathFromDB(
