...
public class IpcActiveBlock implements Serializable {
  ...
  /**
   * This is a transient member so only valid on the server side. Intended for sorting collection of
   * IpcAtiveBlock objects.
   *
  ...
  /**
   * For sorting a collection of IpcActiveBlock objects such that ordered by route order and then by
   * block start time.
   */
