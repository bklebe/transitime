...
public class IpcArrivalDeparture implements Serializable {
  ...
  @XmlAttribute private String vehicleId;
  @XmlAttribute private Date time;
  @XmlAttribute private String stopId;
  @XmlAttribute private int gtfsStopSeq;
  @XmlAttribute private boolean isArrival;
  @XmlAttribute private String tripId;
  @XmlAttribute private transient Date avlTime;
  @XmlAttribute private transient TemporalDifference scheduledAdherence;
  @XmlAttribute private String blockId;
  @XmlAttribute private transient String routeId;
  @XmlAttribute private transient String routeShortName;
  @XmlAttribute private transient String serviceId;
  @XmlAttribute private String directionId;
  @XmlAttribute private transient int tripIndex;
  @XmlAttribute private int stopPathIndex;
  @XmlAttribute private transient float stopPathLength;
  @XmlAttribute private Date freqStartTime;
  ...
  public boolean equals(Object obj) {
    ...
    if (freqStartTime == null) {
      if (other.freqStartTime != null) return false;
    } else if (!freqStartTime.equals(other.freqStartTime)) return false;
  ...
  public String toString() {
    return "IpcArrivalDeparture [vehicleId="
        + vehicleId
        + ", time="
        + time
        + ", stopId="
