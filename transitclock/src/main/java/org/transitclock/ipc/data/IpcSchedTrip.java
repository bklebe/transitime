...
public class IpcSchedTrip implements Serializable {
  ...
  /**
   * Constructor. Goes through the complete ordered list of stops for the direction and creates the
   * corresponding IpcSchedTime objects for each one, even if there is no scheduled time for that
   * stop for the specified trip.
   *
   * @param blockId
   * @param tripId
   * @param scheduleTimes
