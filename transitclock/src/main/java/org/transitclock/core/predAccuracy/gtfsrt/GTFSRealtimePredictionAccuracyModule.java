...
public class GTFSRealtimePredictionAccuracyModule extends PredictionAccuracyModule {
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(GTFSRealtimePredictionAccuracyModule.class);
  ...
  private static ClassConfigValue translatorConfig =
      new ClassConfigValue(
          "transitclock.predAccuracy.RtTranslator",
          null,
  ...
  static HashMap<PredictionReadTimeKey, Long> readTimesMap =
      new HashMap<PredictionReadTimeKey, Long>();
