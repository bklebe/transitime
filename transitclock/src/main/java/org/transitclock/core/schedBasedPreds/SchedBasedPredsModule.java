...
public class SchedBasedPredsModule extends Module {
  ...
  private void createSchedBasedPredsAsNecessary() {
    ...
    for (Block block : activeBlocks) {
      ...
      Collection<String> vehiclesForBlock =
   ...
   * start time of the block by more than the allowable number of minutes (a real vehicle was never
   * assigned to the block).
   *
   * @param vehicleState
   * @param now Current time
   * @return An event description if the schedule based vehicle should be timed out and predictions
   *     should be removed, otherwise null
   */
