...
public class TripEventsKyroSerializer implements Serializer<TripEvents> {
  ...
  public TripEventsKyroSerializer(
      ClassLoader classLoader, FileBasedPersistenceContext persistenceContext) {}

  @Override
  public boolean equals(TripEvents arg0, ByteBuffer arg1)
