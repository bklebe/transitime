...
public class StopArrivalDepartureCache extends StopArrivalDepartureCacheInterface {
  ...
  @SuppressWarnings("unchecked")
  public synchronized StopArrivalDepartureCacheKey putArrivalDeparture(
      ArrivalDeparture arrivalDeparture) {

    logger.debug(
        "Putting :" + arrivalDeparture.toString() + " in StopArrivalDepartureCache cache.");
    ...
    if (arrivalDeparture.getStop() != null) {
      ...
      try {
        ...
        logger.error(
            "Error adding " + arrivalDeparture.toString() + " event to StopArrivalDepartureCache.",
            e);
      }
