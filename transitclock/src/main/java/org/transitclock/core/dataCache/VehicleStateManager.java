...
public class VehicleStateManager {
  ...
  /**
   * Constructor made private because this is singleton class where getInstance() should be used to
   * get the VehicleStateManager.
   */
   ...
   * getting modified when there is a new AVL report when this method is called need to synchronize
   * on the returned VehicleState object if accessing any information that is not atomic, such as
   * the avlReportHistory.
   *
   * @param vehicleId
