...
public class DwellTimeModelCache
  ...
  private static DoubleConfigValue lambda =
      ...
      if (rls.getRls() != null) {
        ...
        logger.debug(
            "Predicted dwell: "
                ...
                + key
                + " based on headway: "
                + TimeUnit.MILLISECONDS.toMinutes((long) headway.getHeadway())
                + " mins");
          ...
          if (arrival != null) {
            ...
            if (arrival != null && previousArrival != null) {
              ...
              if (departure.getScheduleAdherence() != null
                ...
                // Arrival schedule adherence appears not to be set alot. So only stop if set and
                // outside range.
