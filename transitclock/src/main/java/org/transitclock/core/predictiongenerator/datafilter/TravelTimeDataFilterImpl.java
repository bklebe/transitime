...
public class TravelTimeDataFilterImpl implements TravelTimeDataFilter {
  ...
  private static LongConfigValue maxTravelTimeAllowedInModel =
      new LongConfigValue(
  ...
  private static LongConfigValue minTravelTimeAllowedInModel =
      new LongConfigValue(
      ...
      if (arrival.getScheduledAdherence() == null
        ...
        if (arrival.getScheduledAdherence() == null
          ...
          if (traveltime < maxTravelTimeAllowedInModel.getValue()
            ...
            logger.warn(
                "Travel time {} outside allowable range for {} to {}.",
                traveltime,
                departure,
                arrival);
          }
