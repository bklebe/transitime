...
public class LastVehiclePredictionGeneratorImpl extends PredictionGeneratorDefaultImpl
  ...
  private static final Logger logger =
      LoggerFactory.getLogger(LastVehiclePredictionGeneratorImpl.class);
  ...
  public long getTravelTimeForPath(
    ...
    try {
      ...
      if ((travelTimeDetails = this.getLastVehicleTravelTime(currentVehicleState, indices))
          != null) {
        logger.debug(
            "Using last vehicle algorithm for prediction : "
