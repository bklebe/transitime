...
public class ExponentialBiasAdjuster implements BiasAdjuster {
  ...
  private static DoubleConfigValue baseNumber =
  ...
  private static DoubleConfigValue multiple =
      new DoubleConfigValue(
          "org.transitclock.core.predictiongenerator.bias.exponential.a",
          0.5,
          "Multiple.y=a(b^x)+c.");

  private static DoubleConfigValue constant =
      new DoubleConfigValue(
          "org.transitclock.core.predictiongenerator.bias.exponential.c",
          -0.5,
          "Constant. y=a(b^x)+c.");

  private static IntegerConfigValue updown =
