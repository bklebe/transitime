...
public class Test {
  ...
  public static void main(String[] args) {
    ...
    TitleFormatter titleFormatter = new TitleFormatter("/GTFS/sfmta/titlesReplacements.txt", true);

    GtfsRoutesSupplementReader routesSupplementReader =
        new GtfsRoutesSupplementReader(gtfsSupplementDir);
    ...
    for (GtfsRoute r : gtfsRoutes) {
      ...
      if (gtfsDir.contains("sfmta")) {
        ...
        if (!r.getRouteLongName().isEmpty()) routeName = r.getRouteLongName();
        else routeName = r.getRouteShortName();
      }
    ...
    System.out.println("\nAgencies:");
    for (GtfsAgency a : gtfsAgencies) System.out.println("agency=" + a);
    ...
    System.out.println("\nCalendar Dates:");
    for (GtfsCalendarDate o : gtfsCalendarDates) System.out.println("calendar date=" + o);
