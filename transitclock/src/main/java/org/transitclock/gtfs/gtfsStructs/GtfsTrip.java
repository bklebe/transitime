...
public class GtfsTrip extends CsvBase {
  ...
  private static StringConfigValue tripShortNameRegEx =
  ...
  private static StringConfigValue blockIdRegEx =
      new StringConfigValue(
  ...
  public GtfsTrip(CSVRecord record, boolean supplemental, String fileName) {
    ...
    wheelchairAccessible =
        wheelchairAccessibleStr == null ? null : Integer.parseInt(wheelchairAccessibleStr);
  ...
  /**
   * When combining a regular trip with a supplemental trip need to create a whole new object since
  ...
  public GtfsTrip(GtfsTrip originalTrip, GtfsTrip supplementTrip) {
    ...
    wheelchairAccessible =
        s.wheelchairAccessible == null ? o.wheelchairAccessible : s.wheelchairAccessible;
