...
public class HttpGetGtfsFile extends HttpGetFile {
   ...
   * @param directory where to put the retrieved file. If null then getDirectoryForStoringFile() is
  ...
  /**
   * Main entry point to class. Reads in specified file from URL and stores it using same file name
   * into directory specified by getDirectoryForFile(). The directory name will be something like
