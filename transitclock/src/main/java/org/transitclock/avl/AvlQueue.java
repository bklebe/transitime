...
public class AvlQueue extends ArrayBlockingQueue<Runnable> {
  ...
  private boolean isObsolete(Runnable runnableFromQueue) {
    ...
    boolean obsolete =
        lastAvlReportForVehicle != null
            && avlReportFromQueue.getTime() < lastAvlReportForVehicle.getTime();
    if (obsolete) {
      logger.debug(
  ...
  /**
   * Calls superclass add() method but also updates the AVL data per vehicle map. Doesn't seem to be
   * used by ThreadPoolExecutor but still included for completeness.
   */
  @Override
  ...
  /**
   * Calls superclass put() method but also updates the AVL data per vehicle map. Doesn't seem to be
   * used by ThreadPoolExecutor but still included for completeness.
   */
  @Override
  ...
  /**
   * Calls superclass poll() method until it gets AVL data that is not obsolete. Doesn't seem to be
   * used by ThreadPoolExecutor but still included for completeness.
   */
  @Override
  ...
  /**
   * Calls superclass take() method until it gets AVL data that is not obsolete. Doesn't seem to be
   * used by ThreadPoolExecutor but still included for completeness.
   */
  @Override
