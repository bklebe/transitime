...
public class IntervalTimer {
  ...
  /**
   * toString() is defined so that it works well when debug logging. This way can pass in reference
   * to the timer object. Only if debug logging is enabled will the toString() be called causing the
   * string to actually be generated.
   */
  @Override
