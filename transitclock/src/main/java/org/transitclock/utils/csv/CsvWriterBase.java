...
public abstract class CsvWriterBase {
   ...
   *
   * <p>To write a file one uses a subclass that specifies how to write the header and a line to the
   * file for each GTFS object. One simply constructs the subclass (which creates the file and
   ...
   *
   * @param fileName
   * @param append Set to true if should append data to CSV file if it already exists. If false then
   *     will write new file along with the header.
   */
