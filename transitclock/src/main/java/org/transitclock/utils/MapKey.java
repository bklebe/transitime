 ...
 * keys a shortcut is taken where one simply appends strings together along with a separator
 * character so one gets a key such as "string1|string2". But that is really clunky. Best to do it
 * right and use this class as the key for a map.
 *
 * <p>It is probably best to subclass this class for each type of map key so that you can make sure
 * that the proper type of key is used for the map. Otherwise it could be confusing if one has
 * multiple different MapKeys. An example of such a subclass is:
 *
 * <p><code>
...
public class MapKey {
   ...
   *
   * @param o1 Object to be part of the key
   * @param o2 Object to be part of the key
   */
   ...
   * @param o1 Object to be part of the key
   * @param o2 Object to be part of the key
   * @param o3 Object to be part of the key
   */
   ...
   * @param o2 Object to be part of the key
   * @param o3 Object to be part of the key
   * @param o4 Object to be part of the key
   */
   ...
   * For when key consists of two strings.
   *
   * @param o1 Object to be part of the key
   * @param o2 Object to be part of the key
  ...
  /**
   * A different way of creating a MapKey by using a static method instead of using new MapKey().
   * For when key consists of three strings.
   *
   * @param o1 Object to be part of the key
   * @param o2 Object to be part of the key
   * @param o3 Object to be part of the key
  ...
  /**
   * A different way of creating a MapKey by using a static method instead of using new MapKey().
   * For when key consists of four objects.
   *
   * @param o1 Object to be part of the key
   * @param o2 Object to be part of the key
   * @param o3 Object to be part of the key
  ...
  /**
   * Using cached hash code for speed. Therefore this method is used by constructors to initialize
  ...
  public boolean equals(Object obj) {
    ...
    if (o3 == null) {
      if (other.o3 != null) return false;
    } else if (!o3.equals(other.o3)) return false;
    if (o4 == null) {
      if (other.o4 != null) return false;
    } else if (!o4.equals(other.o4)) return false;
    return true;
  }

  @Override
  public String toString() {
    return "MapKey [" + "o1=" + o1 + ", o2=" + o2 + ", o3=" + o3 + ", o4=" + o4 + "]";
  }
}
