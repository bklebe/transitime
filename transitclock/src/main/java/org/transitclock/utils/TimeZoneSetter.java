...
public class TimeZoneSetter {
   ...
   * transitclock.core.timezone. Ideally would get timezone from the agency db but once a Hibernate
   * session factory is created, such as for reading timezone from db, then it is too late to set
   * the timezone. Therefore this provides ability to set it manually.
   */
