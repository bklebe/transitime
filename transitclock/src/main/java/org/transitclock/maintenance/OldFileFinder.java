...
public abstract class OldFileFinder {
  ...
  /**
   * Constructor. Recursively goes through specified directory and finds files older than specified
   * number of days and calls the abstract method handleFile() on them.
   *
   ...
   * been called on each file and handleDirectoryWithOldFile() has been called for directories with
   * old files.
   *
   * @param directory
   */
