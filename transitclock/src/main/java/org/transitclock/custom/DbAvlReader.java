...
public class DbAvlReader extends Module {
  ...
  private static StringConfigValue dbQuery =
      new StringConfigValue(
          "transitclock.avl.dbQuery",
          "select ID as Id, BusID as busId, "
              ...
              + "RptDate as reportDate from tblbuses;",
  ...
  private static IntegerConfigValue pollingRateMsec =
      new IntegerConfigValue(
          "transitclock.avl.pollingRateMsec", 30000, "Milliseconds between AVL database polls");
