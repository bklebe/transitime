 ...
 *     <p>This module takes data from traccar and forwards it to a barefoot server instances to have
 *     it map matched to a GTFS route.
 *     <p>The BarefootAVLModule should be configured with this module to read the adjusted AVL from
 *     the barefoot server for processing by TheTransitClock.
 */
public class TraccarBarefootAVLModule extends TraccarAVLModule {
  ...
  private static IntegerConfigValue barefootPort =
      new IntegerConfigValue(
          "transitclock.avl.barefoot.port",
          1235,
  ...
  private static StringConfigValue barefootServer =
      new StringConfigValue(
          "transitclock.avl.barefoot.server",
          "127.0.0.1",
          "This is the server that is running the barefoot service.");
