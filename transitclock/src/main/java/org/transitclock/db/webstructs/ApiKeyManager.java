...
public class ApiKeyManager {
  ...
  private static IntegerConfigValue lastTimeKeysReadLimitSec =
   ...
   * hibernate.cfg.xml file if the parameter transitclock.hibernate.configFile in the CoreConfig is
   * set.
   *
   * @return
   */
  ...
  /**
   * Generates the key based on the application name. This isn't intended to be secure so simply use
   * hashCode() to generate a key and use hex form of it for consistency and compactness.
   *
  ...
  public static void main(String[] args) {
    if (args.length != 5) {
      System.err.println(
          "Must supply arguments for applicationName, "
