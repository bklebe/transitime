...
public class PredictionAccuracy implements Lifecycle, Serializable {
  ...
  @Column private final int predictionAccuracyMsecs;
  ...
  /* TODO */
  // @Column(length=HibernateUtils.DEFAULT_ID_SIZE)
  @Transient private String predictionAlgorithm;

  @Column(length = HibernateUtils.DEFAULT_ID_SIZE)
  private String vehicleId;

  @Column private final Boolean affectedByWaitStop;
  ...
  public PredictionAccuracy(
    ...
    this.predictionAccuracyMsecs =
        arrivalDepartureTime != null
            ? (int) (arrivalDepartureTime.getTime() - predictedTime.getTime())
            : 0;
  ...
  public int hashCode() {
    ...
    result =
        prime * result + ((arrivalDepartureTime == null) ? 0 : arrivalDepartureTime.hashCode());
