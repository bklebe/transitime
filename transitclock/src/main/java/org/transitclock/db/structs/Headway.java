...
public class Headway implements Serializable {
  ...
  @Column private double headway;

  @Column private double average;

  @Column private double variance;

  @Column private double coefficientOfVariation;

  @Column private int numVehicles;
