...
public class ScheduleTime implements Serializable {
  ...
  /**
   * Time of day in seconds. Will be null if there is no arrival time (even if there is a departure
   * time). There will be no arrival time unless it is last stop in trip.
   *
   * @return
   */
  ...
  /**
   * Time of day in seconds. Will be null if there is no departure time (even if there is an arrival
   * time). There will be no departure time if last stop of trip.
   *
   * @return
   */
