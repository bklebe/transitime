...
public class Agency implements Serializable {
  ...
  @Column private final String agencyUrl;
  ...
  @Column private final String agencyFareUrl;

  @Embedded private final Extent extent;

  @Transient private TimeZone timezone = null;
  ...
  /**
   * Note that this method returns the GTFS agency_id which is usually different from the Transitime
   * agencyId
   *
   * @return the agencyId
   */
