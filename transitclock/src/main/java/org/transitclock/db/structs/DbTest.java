...
public class DbTest {
  ...
  public static List<DbTest> readAll(String agencyId) throws HibernateException {
    ...
    try {
      ...
      logger.error(
          "Could not get DbTest object. {}. {}", e.getCause().getMessage(), e.getMessage());
      throw e;
    } finally {
      session.close();
    }
  ...
  public static boolean write(String agencyId, int id) throws HibernateException {
    ...
    try {
      ...
      logger.error(
          "Could not write DbTest object. {}. {}", e.getCause().getMessage(), e.getMessage());
      throw e;
    } finally {
      session.close();
    }
  ...
  public static int deleteAll(String agencyId) throws HibernateException {
    ...
    try {
      ...
      logger.error(
          "Could not delete DbTest objects. {}. {}", e.getCause().getMessage(), e.getMessage());
      throw e;
    } finally {
      session.close();
    }
