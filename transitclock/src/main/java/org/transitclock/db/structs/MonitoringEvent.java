...
public class MonitoringEvent implements Serializable {
  ...
  @Column private final boolean triggered;
  ...
  @Column private final double value;
  ...
  public static MonitoringEvent create(
      Date time, String type, boolean triggered, String message, double value) {
  ...
  public static List<MonitoringEvent> getMonitoringEvents(
    ...
    String hql =
        "FROM MonitorEvent " + "    WHERE time >= :beginDate " + "      AND time < :endDate";
