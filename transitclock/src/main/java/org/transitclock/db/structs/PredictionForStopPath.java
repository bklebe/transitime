...
public class PredictionForStopPath implements Serializable {
  ...
  @Column private Double predictionTime;

  @Column(length = HibernateUtils.DEFAULT_ID_SIZE)
  private String tripId;

  @Column private Integer startTime;

  @Column private String algorithm;

  @Column private Integer stopPathIndex;

  @Column private String vehicleId;

  @Column private boolean travelTime;
