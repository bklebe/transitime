...
public class Vector implements Serializable {
  ...
  /**
   * Returns in radians either the angle counterclockwise from the equator or the heading clockwise
   * from north.
   *
  ...
  public Vector beginning(double beginningLength) {
    ...
    Location newL2 =
        new Location(
            l1.getLat() + ratio * (l2.getLat() - l1.getLat()),
  ...
  public static void main(String[] args) {
    ...
    System.err.println(
        "offset, " + Geo.format(offset.getLat()) + ", " + Geo.format(offset.getLon()));
  }
