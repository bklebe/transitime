...
public class MeasuredArrivalTime implements Serializable {
   ...
   * is stored by the core system. But MeasuredArrivalTime objects are written by the website, which
   * doesn't use Hibernate to write objects since it has to be able to talk with any db.
   *
