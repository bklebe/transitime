...
public class VehicleEvent implements Serializable {
  ...
  @Column private final boolean predictable;
  ...
  // Using boolean instead of Boolean because it is a required element
  // and must therefore not be null.
  @Column private final boolean becameUnpredictable;
  ...
  /**
   * Simple constructor. Declared private because should be only accessed by the create() method so
   * that can make sure that do things like log each creation of a VehicleEvent.
   *
   * @param time
   * @param avlTime
   * @param vehicleId
  ...
  public boolean equals(Object obj) {
    ...
    if (becameUnpredictable != other.becameUnpredictable) return false;
    if (blockId == null) {
    ...
    if (predictable != other.predictable) return false;
    if (routeId == null) {
    ...
    if (supervisor == null) {
      if (other.supervisor != null) return false;
    } else if (!supervisor.equals(other.supervisor)) return false;
    if (time == null) {
