...
public class Calendar implements Serializable {
  ...
  @Column @Id private final boolean monday;

  @Column @Id private final boolean tuesday;

  @Column @Id private final boolean wednesday;

  @Column @Id private final boolean thursday;

  @Column @Id private final boolean friday;

  @Column @Id private final boolean saturday;

  @Column @Id private final boolean sunday;
  ...
  /**
   * End of the last day of service. This means that when an end date is specified the service runs
   * for up to and including that day. Since days start at midnight, this method returns the endDate
   * plus 1 day so that it represents midnight of the configured endDate.
   *
