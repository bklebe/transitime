...
public class TravelTimesForStopPath implements Serializable {
  ...
  // generated ID.
  @Id @Column @GeneratedValue private Integer id;
  ...
  @Column private final float travelTimeSegmentLength;
  ...
  @Column private final int stopTimeMsec;
  ...
  @Column private final short daysOfWeekOverride;
   ...
   * @return
   */
  public static List<TravelTimesForStopPath> getTravelTimes(
      SessionFactory sessionFactory, int configRev) {
  ...
  public boolean equals(Object obj) {
    ...
    if (Float.floatToIntBits(travelTimeSegmentLength)
        != Float.floatToIntBits(other.travelTimeSegmentLength)) return false;
    if (travelTimesMsec == null) {
