...
public class Transfer implements Serializable {
  ...
  @Column private final Integer minTransferTime;
  ...
  public int hashCode() {
    ...
    result = prime * result + ((minTransferTime == null) ? 0 : minTransferTime.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (fromStopId == null) {
      if (other.fromStopId != null) return false;
    } else if (!fromStopId.equals(other.fromStopId)) return false;
    if (minTransferTime == null) {
      if (other.minTransferTime != null) return false;
    } else if (!minTransferTime.equals(other.minTransferTime)) return false;
    if (toStopId == null) {
      if (other.toStopId != null) return false;
    } else if (!toStopId.equals(other.toStopId)) return false;
    if (transferType == null) {
      if (other.transferType != null) return false;
    } else if (!transferType.equals(other.transferType)) return false;
    return true;
  }
