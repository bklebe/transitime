...
public class Match implements Lifecycle, Serializable {
  ...
  // was created
  @Column private final int configRev;
  ...
  @Column private final int segmentIndex;

  // Not currently needed. Added for possible future uses of Match
  @Column private final float distanceAlongSegment;
  ...
  @Column private final float distanceAlongStopPath;
  ...
  @Column private final boolean atStop;
  ...
  public boolean equals(Object obj) {
    ...
    if (Float.floatToIntBits(distanceAlongSegment)
        != Float.floatToIntBits(other.distanceAlongSegment)) return false;
    if (Float.floatToIntBits(distanceAlongStopPath)
        != Float.floatToIntBits(other.distanceAlongStopPath)) return false;
  ...
  public static Long getMatchesCountFromDb(
      String projectId, Date beginTime, Date endTime, String sqlClause) {
    IntervalTimer timer = new IntervalTimer();
