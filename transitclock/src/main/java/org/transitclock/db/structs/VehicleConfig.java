...
public class VehicleConfig {
  ...
  @Column private final Integer type;

  // A more verbose description of the vehicle.
  @Column private final String description;
  ...
  @Column private final Integer capacity;

  // Absolute crush capacity of vehicle. Number of people who can be
  // squeezed in.
  @Column private final Integer crushCapacity;

  // If true then a non-revenue vehicle.
  @Column private final Boolean nonPassengerVehicle;
  ...
  /**
   * @return The type of the vehicle. Should be same as GTFS route type: 0 - Tram, Streetcar, Light
   *     rail. Any light rail or street level system within a metropolitan area. 1 - Subway, Metro.
   *     Any underground rail system within a metropolitan area. 2 - Rail. Used for intercity or
   ...
   *     cars where the cable runs beneath the car. 6 - Gondola, Suspended cable car. Typically used
   *     for aerial cable cars where the car is suspended from the cable. 7 - Funicular. Any rail
   *     system designed for steep inclines.
   */
