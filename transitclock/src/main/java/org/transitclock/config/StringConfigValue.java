...
public class StringConfigValue extends ConfigValue<String> {
  ...
  /**
   * Constructor. For when there is no default value. Error will occur when parameter is initialized
   ...
   *
   * @param id
   * @param defaultValue Default value, but can be set to null for if null is a reasonable default.
   * @param description
   */
   ...
   *     such.
   */
  public StringConfigValue(
      String id, String defaultValue, String description, boolean okToLogValue) {
