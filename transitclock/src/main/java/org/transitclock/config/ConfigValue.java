...
public abstract class ConfigValue<T> {
   ...
   * @param defaultValue
   * @param description
   * @param okToLogValue If false then won't log value in log file. This is useful for passwords and
   *     such.
   */
  ...
  /**
   * Returns the ID of the parameter. This can be useful for outputting as part of error messages so
   * that user can see what parameter needs to be modified when there is a problem.
   *
   * @return
   */
  public String getID() {
  ...
  /**
   * Values need to be converted from string to the value. This is done in different ways depending
   * on the type (Integer, Float, String, etc). Therefore this method needs to be abstract and the
   * real work is done in the appropriate superclass.
   *
   * @param dataStr
   */
