...
public class LoggingTest {
  ...
  public static void main(String[] args) {
    ...
    s_logger.error(
        Markers.email(), "Core error message", new Exception("special exception message"));
    s_logger.error(
        Markers.email(), "2nd Core error message", new Exception("2nd special exception message"));
  }
}
