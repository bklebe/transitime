...
public class SiriApi {
  ...
  /**
   * Returns vehicleMonitoring vehicle information in SIRI format. Can specify vehicleIds, routeIds,
   * or routeShortNames to get subset of data. If not specified then vehicle information for entire
   * agency is returned.
   *
   * @param stdParameters
  ...
  @Operation(
      ...
      description =
          "It is possible to specify vehicleIds, routeIds, or routeShortNames "
