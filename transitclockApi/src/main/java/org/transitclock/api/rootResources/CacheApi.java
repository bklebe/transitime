...
public class CacheApi {
  ...
  @Operation(
      summary =
          "Gets a list of the keys that have values in the historical average cache for schedules based services.",
      description =
          "Gets a list of the keys that have values in the historical average cache for schedules based services.",
      tags = {"cache"})
  public Response getSchedulesBasedHistoricalAverageCacheKeys(
  ...
  @Operation(
      summary =
          "Gets a list of the keys that have values in the historical average cache for frequency based services.",
      description =
          "Gets a list of the keys that have values in the historical average cache for frequency based services."
              + "<font color=\"#FF0000\">This is not completed and should not be used.<font>",
      tags = {"cache"})
  public Response getFrequencyBasedHistoricalAverageCacheKeys(
      @BeanParam StandardParameters stdParameters) throws WebApplicationException {
    try {
      CacheQueryInterface cachequeryInterface = stdParameters.getCacheQueryInterface();
  ...
  @Operation(
      ...
      description =
          "Returns the number of entries in the cacheName cache. The name is passed throug the cachename parameter.",
      tags = {"cache"})
  public Response getCacheInfo(
      @BeanParam StandardParameters stdParameters,
      @Parameter(description = "Name of the cache", required = true)
          @QueryParam(value = "cachename")
          String cachename)
      throws WebApplicationException {
    try {
  ...
  public Response getStopArrivalDepartureCacheData(
      @BeanParam StandardParameters stdParameters,
      @Parameter(description = "Stop Id.", required = true) @QueryParam(value = "stopid")
          String stopid,
  ...
  @Operation(
      ...
      description =
          "Returns a list  of the arrivals and departures for a trip on a specific day and start time."
  ...
  @Operation(
      ...
      description =
          "Returns the historical cache value for an individual stop path index of a trip.",
      tags = {"cache"})
  public Response getHistoricalAverageCacheData(
      ...
      @Parameter(description = "Stop path index", required = true)
          @QueryParam(value = "stopPathIndex")
  ...
  public Response getStopPathPredictions(
    ...
    try {
      ...
      PredictionAnalysisInterface predictionAnalysisInterface =
          stdParameters.getPredictionAnalysisInterface();

      List<IpcPredictionForStopPath> result =
          predictionAnalysisInterface.getCachedTravelTimePredictions(
  ...
  public Response getHoldingTime(
      ...
      @Parameter(description = "Stop id", required = true) @QueryParam(value = "stopId")
          String stopId,
      @Parameter(description = "Vehicle id", required = true) @QueryParam(value = "vehicleId")
          String vehicleId) {
    try {
