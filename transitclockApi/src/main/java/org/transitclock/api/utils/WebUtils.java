...
public class WebUtils {
  ...
  /**
   * Convenience method for when need to throw a special HTTP response exception, such as 429 which
   * means Too Many Requests. See http://en.wikipedia.org/wiki/List_of_HTTP_status_codes for details
