...
public class ApiHoldingTime {
  ...
  @XmlAttribute private Date holdingTime;

  @XmlAttribute private Date creationTime;

  @XmlAttribute private Date currentTime;
  ...
  @XmlAttribute private boolean arrivalPredictionUsed;

  @XmlAttribute private boolean arrivalUsed;

  @XmlAttribute private Date arrivalTime;

  @XmlAttribute private boolean hasN1;

  @XmlAttribute private boolean hasN2;

  @XmlAttribute private boolean hasD1;

  @XmlAttribute private int numberPredictionsUsed;
