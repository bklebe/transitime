...
/**
 * Represents a collection of ApiScheduleHorizStops objects for a route. There is one
 * ApiScheduleHoriztStops for each direction/service for a route. The stops are listed horizontally
 * in the matrix. For when there are many trips in a day, such as for bus routes.
 *
 * @author SkiBu Smith
 */
