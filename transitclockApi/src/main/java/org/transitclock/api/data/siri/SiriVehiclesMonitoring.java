  ...
  private static class SiriVehicleMonitoringDelivery {
    ...
    public SiriVehicleMonitoringDelivery(
      ...
      for (IpcVehicleComplete vehicle : vehicles) {
        vehicleActivityList.add(
            new SiriVehicleActivity(vehicle, agencyId, timeFormatter, dateFormatter));
      }
    }
  }
    ...
    public SiriVehicleActivity(
      ...
      monitoredVehicleJourney =
          new SiriMonitoredVehicleJourney(
              ipcCompleteVehicle, null, agencyId, timeFormatter, dateFormatter);
    }
  }
