...
public abstract class ApiVehicleAbstract {
  ...
  @XmlElement protected ApiGpsLocation loc;

  @XmlAttribute protected String routeId;

  @XmlAttribute protected String routeShortName;

  @XmlAttribute protected String headsign;

  @XmlAttribute(name = "direction")
  protected String directionId;

  @XmlAttribute protected String vehicleType;

  // Whether NORMAL, SECONDARY, or MINOR. Specifies how vehicle should
  // be drawn in the UI
  @XmlAttribute protected String uiType;
