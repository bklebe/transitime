...
public class ApiCalendar {
  ...
  @XmlAttribute private boolean monday;

  @XmlAttribute private boolean tuesday;

  @XmlAttribute private boolean wednesday;

  @XmlAttribute private boolean thursday;

  @XmlAttribute private boolean friday;

  @XmlAttribute private boolean saturday;

  @XmlAttribute private boolean sunday;

  @XmlAttribute private String startDate;

  @XmlAttribute private String endDate;
