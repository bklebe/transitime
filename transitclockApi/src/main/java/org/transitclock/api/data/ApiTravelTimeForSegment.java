...
public class ApiTravelTimeForSegment {
  ...
  @XmlAttribute private int segmentIndex;

  @XmlAttribute private int segmentTimeMsec;

  @XmlAttribute private Double speedInMph;

  @XmlAttribute private Double speedInKph;

  @XmlAttribute private Double speedInMetersPerSec;
