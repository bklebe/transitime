...
public class ApiTravelTimes {
  ...
  @XmlAttribute private int travelTimeRev;

  @XmlAttribute private String tripPatternId;

  @XmlAttribute private String tripCreatedForId;
  ...
  public ApiTravelTimes(TravelTimesForTrip travelTimes) {
    ...
    for (int stopPathIndex = 0;
      ...
      this.travelTimesForStopPaths.add(
          new ApiTravelTimesForStopPath(stopPathIndex, travelTimesForStopPath));
    }
  }
}
