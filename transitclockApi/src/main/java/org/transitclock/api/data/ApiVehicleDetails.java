...
public class ApiVehicleDetails extends ApiVehicleAbstract {
  ...
  @XmlAttribute private String routeName;
  ...
  @XmlAttribute private Long layoverDepTime;

  @XmlAttribute private String layoverDepTimeStr;

  @XmlAttribute private String nextStopId;

  @XmlAttribute private String nextStopName;

  @XmlElement(name = "driver")
  private String driverId;

  @XmlAttribute private Boolean isScheduledService;

  @XmlAttribute private Long freqStartTime;

  @XmlAttribute private Boolean isAtStop;

  @XmlElement private ApiHoldingTime holdingTime;

  @XmlAttribute private double distanceAlongTrip;

  @XmlAttribute private String licensePlate;

  @XmlAttribute private boolean isCanceled;

  @XmlAttribute private double headway;
   ...
   * @param uiType Optional parameter. If should be labeled as "minor" in output for UI. Default is
   *     UiMode.NORMAL.
  ...
  public ApiVehicleDetails(IpcVehicle vehicle, Time timeForAgency, UiMode... uiType)
    ...
    scheduleAdherence =
        vehicle.getRealTimeSchedAdh() != null
            ? vehicle.getRealTimeSchedAdh().getTemporalDifference()
            : null;
    scheduleAdherenceStr =
        vehicle.getRealTimeSchedAdh() != null ? vehicle.getRealTimeSchedAdh().toString() : null;
    ...
    layoverDepTime =
        vehicle.isLayover() ? vehicle.getLayoverDepartureTime() / Time.MS_PER_SEC : null;

    layoverDepTimeStr =
        vehicle.isLayover()
            ? timeForAgency.timeStrForTimezone(vehicle.getLayoverDepartureTime())
            : null;
