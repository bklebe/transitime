...
public class ApiAgency {
  ...
  @XmlAttribute private String agencyId;
  ...
  @XmlAttribute private String timezone;

  @XmlAttribute private int timezoneOffsetMinutes;

  @XmlAttribute private String lang;

  @XmlAttribute private String phone;

  @XmlAttribute private String fareUrl;

  @XmlElement private ApiExtent extent;
