...
public class ApiAdherenceSummary {
  ...
  @XmlAttribute private Integer late;

  @XmlAttribute private Integer ontime;

  @XmlAttribute private Integer early;

  @XmlAttribute private Integer nodata;

  @XmlAttribute private Integer blocks;
