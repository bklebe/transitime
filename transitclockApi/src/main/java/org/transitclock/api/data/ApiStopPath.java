...
public class ApiStopPath {
  ...
  @XmlAttribute private String stopName;

  @XmlAttribute private int gtfsStopSeq;

  @XmlAttribute private Boolean layoverStop;

  @XmlAttribute private Boolean waitStop;

  @XmlAttribute private Boolean scheduleAdherenceStop;

  @XmlAttribute private Integer breakTime;

  @XmlElement private List<ApiLocation> locations;

  @XmlAttribute private Double pathLength;
