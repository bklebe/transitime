...
public class ApiTravelTimesForStopPath {
  ...
  @XmlAttribute private String stopPathId;

  @XmlAttribute private Double travelTimeSegmentLength;

  @XmlAttribute private int stopTimeMsec;

  @XmlAttribute private int totalTravelTimeMsec;

  @XmlAttribute private HowSet howSet;
   ...
   */
  public ApiTravelTimesForStopPath(
      int stopPathIndex, TravelTimesForStopPath travelTimesForStopPath) {
    this.stopPathIndex = stopPathIndex;
    this.stopPathId = travelTimesForStopPath.getStopPathId();
    double travelTimeSegLengthValue =
        MathUtils.round(travelTimesForStopPath.getTravelTimeSegmentLength(), 1);
    this.travelTimeSegmentLength =
        Double.isNaN(travelTimeSegLengthValue) ? null : travelTimeSegLengthValue;
