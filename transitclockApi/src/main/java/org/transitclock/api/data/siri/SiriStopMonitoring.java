...
public class SiriStopMonitoring {
  @XmlAttribute private String version = "1.3";

  @XmlAttribute private String xmlns = "http://www.siri.org.uk/siri";
  ...
  @XmlTransient private final DateFormat siriDateFormat = new SimpleDateFormat("yyyy-MM-dd");
  ...
  private static class SiriStopMonitoringDelivery {
     ...
     * @return
     */
    private IpcVehicleComplete getVehicle(
        IpcPrediction pred, Collection<IpcVehicleComplete> vehicles) {
  ...
  private static class SiriMonitoredStopVisit {
    ...
    public SiriMonitoredStopVisit(
      ...
      monitoredVehicleJourney =
          new SiriMonitoredVehicleJourney(
  ...
  public SiriStopMonitoring(
    ...
    delivery =
        new SiriServiceDelivery(preds, vehicles, agencyId, siriDateTimeFormat, siriDateFormat);
  }
}
