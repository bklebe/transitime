...
@XmlType(
    propOrder = {"id", "type", "description", "capacity", "crushCapacity", "nonPassengerVehicle"})
public class ApiVehicleConfig {
  ...
  @XmlAttribute private Integer crushCapacity;

  @XmlAttribute private Boolean nonPassengerVehicle;
