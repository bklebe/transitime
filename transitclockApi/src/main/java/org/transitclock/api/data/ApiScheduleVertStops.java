...
public class ApiScheduleVertStops {
  ...
  @XmlAttribute private String serviceName;
  ...
  @XmlElement private List<ApiScheduleTimesForStop> timesForStop;
  ...
  public ApiScheduleVertStops(IpcSchedule ipcSched) {
    ...
    List<IpcSchedTime> schedTimesForFirstTrip = ipcSched.getIpcSchedTrips().get(0).getSchedTimes();
