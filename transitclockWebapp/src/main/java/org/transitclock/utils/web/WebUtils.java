...
public class WebUtils {
   ...
   * String version of a JSON set of key values. This string can be used as the data parameter for a
   * JQuery AJAX call to forward all parameters to the page being requested via AJAX.
   *
   * @param request
