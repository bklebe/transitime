...
public class ScheduleAdherenceController {
  ...
  private static IntegerConfigValue scheduleEarlySeconds =
      new IntegerConfigValue(
          "transitclock.web.scheduleEarlyMinutes", -120, "Schedule Adherence early limit");
  ...
  private static IntegerConfigValue scheduleLateSeconds =
      new IntegerConfigValue(
          "transitclock.web.scheduleLateMinutes", 420, "Schedule Adherence late limit");
  ...
  private static final Projection ADHERENCE_PROJECTION =
      Projections.sqlProjection(
          ADHERENCE_SQL, new String[] {"scheduleAdherence"}, new Type[] {DoubleType.INSTANCE});
  private static final Projection AVG_ADHERENCE_PROJECTION =
      Projections.sqlProjection(
          "avg" + ADHERENCE_SQL,
          new String[] {"scheduleAdherence"},
  ...
  public static List<Object> stopScheduleAdherence(
    ...
    return groupScheduleAdherence(
        startDate, numDays, startTime, endTime, "stopId", stopIds, byStop, datatype);
  }
  ...
  public static List<Object> routeScheduleAdherence(
    ...
    return groupScheduleAdherence(
        startDate, numDays, startTime, endTime, "routeId", routeIds, byRoute, datatype);
  }
  ...
  public static List<Integer> routeScheduleAdherenceSummary(
    ...
    int ontime = 0;
    Double earlyLimit =
        (usePredictionLimits.getValue()
            ? earlyLimitParam
            : (double) scheduleEarlySeconds.getValue());
    Double lateLimit =
        (usePredictionLimits.getValue() ? lateLimitParam : (double) scheduleLateSeconds.getValue());
    List<Object> results =
        routeScheduleAdherence(startDate, numDays, startTime, endTime, routeIds, false, null);
    ...
    logger.info(
        ...
        latePercent);
    Integer[] summary =
        new Integer[] {count, (int) earlyPercent, (int) onTimePercent, (int) latePercent};
  ...
  private static List<Object> groupScheduleAdherence(
    ...
    DetachedCriteria criteria =
        DetachedCriteria.forClass(ArrivalDeparture.class)
