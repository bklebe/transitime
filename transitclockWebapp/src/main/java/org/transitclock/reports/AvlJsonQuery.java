...
public class AvlJsonQuery {
  ...
  /**
   * Queries agency for AVL data and returns result as a JSON string. Limited to returning MAX_ROWS
   * (50,000) data points.
   *
   * @param agencyId
   * @param vehicleId Which vehicle to get data for. Set to null or empty string to get data for all
   *     vehicles
  ...
  public static String getAvlJson(
    ...
    String sql =
        "SELECT vehicleId, time, assignmentId, lat, lon, speed, "
  ...
  /**
   * Queries agency for AVL data and corresponding Match and Trip data. By joining in Match and Trip
   * data can see what the block and trip IDs, the routeShortName, and possibly other information,
   * for each AVL report. Returns result as a JSON string. Limited to returning MAX_ROWS (50,000)
   * data points.
   *
   * @param agencyId
   ...
   * @param routeId Which route to get data for. Set to empty string to get data for all routes. If
   *     null then will get data by vehicle.
   * @param beginDate date to start query
   * @param numdays of days to collect data for
   * @param beginTime optional time of day during the date range
   * @param endTime optional time of day during the date range
