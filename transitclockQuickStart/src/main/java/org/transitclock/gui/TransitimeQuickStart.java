 ...
 *
 * <h1>This is the main repository of code used by the transitimeQuickStart. methods here are called
 * mainly via the input panel when the next button is selected
 *
 * @author Brendan Egan
 */
public class TransitimeQuickStart implements Runnable {
  /**
   * @param ApiKey this hold the apikey value generated by the createapikey method. it used in the
   *     outputpanel to show the correct url.
  ...
  public void extractResources() throws QuickStartException {
    try {
      ExtractResource.extractResourceNIO(
          TransitimeQuickStart.class.getClassLoader(), "hibernate.cfg.xml");
      ExtractResource.extractResourceNIO(
          TransitimeQuickStart.class.getClassLoader(), "transitclock.properties");
  ...
  public void startGtfsFileProcessor(String gtfsZipFileName) throws QuickStartException {
    /**
     * called from input panel Start GtfsFileProcessor using the gtfs file selected from the input
     * panel
     */
    try {
      ...
      if (gtfsZipFileName == null) {
        File gtfsFile =
            ExtractResource.extractResourceFile(this.getClass().getClassLoader(), "Intercity.zip");
  ...
  public void startCore(String realtimefeedURL, String loglocation) throws QuickStartException {
    /**
     * Starts the main core of transitime using the entered realtime feed or default if nothing is
     * entered, feed must be entered correctly as it will only use default if nothing has been
     * passed through for the realtimefeedUrl, if nothing is entered for the loglocation will use
  ...
  public void startDatabase() throws QuickStartException {
    /**
     * Starts database for hsql. this was needed for the way the hsql was configured in the
     * hsql_hibernate file
     */
    try {
