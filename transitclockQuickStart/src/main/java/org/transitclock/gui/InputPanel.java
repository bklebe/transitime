...
/**
 * This is the First and main gui element of the gui, all values needed for the transitimeQuickStart
 * are entered in this panel install jswing should allow you to see and edit the gui.
 *
 * @author Brendan Egan
 */
public class InputPanel extends JFrame {
  /**
   * @parem filelocation where the gtfs is located when selected by the user, will use a default if
   *     nothing entered
   * @parem realtimefeedURL the realtimefeed entered by the user, will use a default if nothing
   *     entered
   * @parem loglocation where the logs will be outputted to, entered by the user, will use a default
   *     if nothing entered, default is currently the directory the application was called
   */
